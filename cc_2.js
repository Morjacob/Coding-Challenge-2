...
const tips1 = bills.map(bill => calculateTip(bill));
const total1 = bills.map((bill,index) => bill + tips [index]);
...
const tips2 = bills.map(bill => calculateTip(bill));
const total2 = bills.map((bill,index) => bill + tips [index]);
